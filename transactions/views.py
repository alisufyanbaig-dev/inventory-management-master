    ...
    def post(self, request, pk):
        ...
        if formset.is_valid():
            ...
            for form in formset:  # for loop to save each individual form as its own object
                ...
                billitem.totalprice = billitem.perprice * billitem.quantity  # calculates the total price
                stock.quantity += billitem.quantity  # updates quantity in stock db
                billdetailsobj.total += billitem.totalprice  # updates the total in bill details
                stock.save()
                billitem.save()
